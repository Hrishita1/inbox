    ...
    return (
        <Wrapper>
            ...
            <Box onClick={() => navigate(routes.view.path, { state: { email: email }})}>
                ...
                <Indicator style={{display: 'flexWrap' }}>Inbox</Indicator>
                <Typography>{email.subject?.length > 25 ? email.subject.slice(0, 25)+ '...' : email.subject } {email.body && '-'} {email.body?.length > 48 ? email.body.slice(0, 48)+ '...': email.body}</Typography>
                <Date>
